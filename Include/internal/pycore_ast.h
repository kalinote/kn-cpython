...
enum _stmt_kind {FunctionDef_kind=1, AsyncFunctionDef_kind=2, ClassDef_kind=3,
                  ...
                  For_kind=10, AsyncFor_kind=11, While_kind=12,
                  DoWhile_kind=13, If_kind=14, With_kind=15, AsyncWith_kind=16,
...
stmt_ty _PyAST_While(expr_ty test, asdl_stmt_seq * body, asdl_stmt_seq *
                     ...
                     end_col_offset, PyArena *arena);
stmt_ty _PyAST_DoWhile(expr_ty test, asdl_stmt_seq * body, asdl_stmt_seq *
                       orelse, int lineno, int col_offset, int end_lineno, int
                       end_col_offset, PyArena *arena);
